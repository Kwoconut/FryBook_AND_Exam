...
public class AddRecipeInstructionsAdapter extends RecyclerView.Adapter<AddRecipeInstructionsAdapter.InstructionHolder> {

    private List<Instruction> instructionList;

    public AddRecipeInstructionsAdapter()
    {
    ...
    @NonNull
    @Override
    public AddRecipeInstructionsAdapter.InstructionHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recipe_add_instructions_item,parent,false);
        return new AddRecipeInstructionsAdapter.InstructionHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddRecipeInstructionsAdapter.InstructionHolder holder, int position) {
