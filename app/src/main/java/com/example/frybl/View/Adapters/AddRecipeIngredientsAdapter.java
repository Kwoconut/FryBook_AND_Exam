...
public class AddRecipeIngredientsAdapter extends RecyclerView.Adapter<AddRecipeIngredientsAdapter.IngredientHolder> {

    private List<Ingredient> ingredientList;

    public AddRecipeIngredientsAdapter()
    {
    ...
    @NonNull
    @Override
    public AddRecipeIngredientsAdapter.IngredientHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recipe_add_ingredients_item,parent,false);
        return new AddRecipeIngredientsAdapter.IngredientHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddRecipeIngredientsAdapter.IngredientHolder holder, int position) {
